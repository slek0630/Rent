...
- (void)viewDidLoad
{
    ...
    if (self.sourceType == UIImagePickerControllerSourceTypeCamera) {
        //恢复上次的相机状态
        UIImagePickerControllerCameraFlashMode flashModel = [[RSettingConfig staticInstance] systemCameraFlashStatus];
...
-(void)viewDidDisappear:(BOOL)animated
{
    if (self.sourceType == UIImagePickerControllerSourceTypeCamera) {
        ...
        [[RSettingConfig staticInstance] setSystemCameraFlashStatus:flashModel];
    }

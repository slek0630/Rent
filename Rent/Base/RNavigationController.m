...
@interface RNavigationController ()

@property (nonatomic, strong) NSMutableArray *needPushArray;
@property (nonatomic, assign) BOOL isPushing;
@property (nonatomic, strong) RCommonVcTransition *tempTransition;
...
- (id <UIViewControllerAnimatedTransitioning>)navigationController:(UINavigationController *)navigationController
    ...
    if(operation == UINavigationControllerOperationPop){
        if([fromVC isKindOfClass:[RSuperViewController class]]){
            RSuperViewController *vc = (RSuperViewController *)fromVC;
...
- (id <UIViewControllerInteractiveTransitioning>)navigationController:(UINavigationController *)navigationController
    ...
    if([animationController isKindOfClass:[RCommonVcTransition class]]){
...
- (UIViewController *)RpopViewControllerAnimated:(id)animated {

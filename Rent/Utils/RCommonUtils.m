...
+ (UInt32)getHanziTextNum:(NSString*)text {
    UInt32 count = [RCommonUtils getDistinctAsciiTextNum:text];
...
+ (void)usePhoneNumAction:(NSString *)phone{
    ...
    RAlertView *alertView = [[RAlertView alloc] initWithTitle:nil message:phone cancelButtonTitle:@"取消" cancelBlock:nil okButtonTitle:@"呼叫" okBlock:^{
